...
education:
  courses:
    - course: PhD in Computer Science
      ...
      year: Ongoing
    - course: M.Tech in Cryptology and Security
...
#  - icon: envelope
#    icon_pack: fas
#    link: 'mailto:j.doe@unsw.edu.au'
  - icon: google-scholar
    icon_pack: fab
    link: https://scholar.google.com/citations?hl=en&user=9vkGr4gAAAAJ
  - icon: orcid
    icon_pack: fab
    link: https://orcid.org/0009-0004-0300-7205
  - icon: github
    icon_pack: fab
